...
class AssetUtils:
    @staticmethod
    def mergeAssets(initialMap: scala.collection.immutable.Map[str, typing.Any], maps: scala.collection.Seq[scala.collection.immutable.Map[str, typing.Any]]) -> scala.collection.immutable.Map[str, typing.Any]: ...
    @staticmethod
    def mergeAssetsMut(into: scala.collection.mutable.Map[str, typing.Any], from_: scala.collection.Seq[scala.collection.immutable.Map[str, typing.Any]]) -> None: ...
    @staticmethod
    def subtractAssets(initialMap: scala.collection.immutable.Map[str, typing.Any], subtractor: scala.collection.Seq[scala.collection.immutable.Map[str, typing.Any]]) -> scala.collection.immutable.Map[str, typing.Any]: ...
    @staticmethod
    def subtractAssetsMut(from_: scala.collection.mutable.Map[str, typing.Any], subtractor: scala.collection.immutable.Map[str, typing.Any]) -> None: ...
...
class Utils:
    @staticmethod
    def paymentTransaction(recipientAddress: org.ergoplatform.ErgoAddress, changeAddress: org.ergoplatform.ErgoAddress, transferAmt: int, feeAmt: int, changeAmt: int, inputIds: typing.List[str], currentHeight: int) -> org.ergoplatform.UnsignedErgoLikeTransaction: ...
