...
class ErgoProverImpl(org.ergoplatform.appkit.ErgoProver):
    ...
    @typing.overload
    def verifySignature(self, addr: org.ergoplatform.P2PKAddress, message: typing.List[int], signedMessage: typing.List[int]) -> bool: ...
    @typing.overload
    def verifySignature(self, sigmaTree: sigmastate.Values.SigmaBoolean, message: typing.List[int], signedMessage: typing.List[int]) -> bool: ...
...
class OutBoxBuilderImpl(org.ergoplatform.appkit.OutBoxBuilder):
    ...
    def mintToken(self, token: org.ergoplatform.appkit.ErgoToken, tokenName: str, tokenDescription: str, tokenNumberOfDecimals: int) -> org.ergoplatform.appkit.OutBoxBuilder: ...
    @typing.overload
...
class OutBoxImpl(org.ergoplatform.appkit.OutBox):
    def __init__(self, _ctx: 'BlockchainContextImpl', _ergoBoxCandidate: org.ergoplatform.ErgoBoxCandidate): ...
...
class UnsignedTransactionImpl(org.ergoplatform.appkit.UnsignedTransaction):
    def __init__(self, unsignedErgoLikeTransaction: org.ergoplatform.UnsignedErgoLikeTransaction, list: java.util.List[org.ergoplatform.appkit.ExtendedInputBox], list2: java.util.List[org.ergoplatform.ErgoBox], list3: java.util.List[org.ergoplatform.ErgoBoxCandidate], ergoAddress: org.ergoplatform.ErgoAddress, ergoLikeStateContext: org.ergoplatform.wallet.protocol.context.ErgoLikeStateContext, blockchainContextImpl: 'BlockchainContextImpl'): ...
