...
class Address:
    ...
    def getErgoContract(self) -> 'ErgoContract': ...
...
class ErgoProver:
    ...
    @typing.overload
    def verifySignature(self, p2PKAddress: org.ergoplatform.P2PKAddress, byteArray: typing.List[int], byteArray2: typing.List[int]) -> bool: ...
    @typing.overload
    def verifySignature(self, sigmaBoolean: sigmastate.Values.SigmaBoolean, byteArray: typing.List[int], byteArray2: typing.List[int]) -> bool: ...
...
class OutBoxBuilder:
    ...
    def mintToken(self, ergoToken: ErgoToken, string: str, string2: str, int: int) -> 'OutBoxBuilder': ...
